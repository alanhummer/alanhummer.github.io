...
function runTheCardGame() {
    ...
    const socket = new WebSocket('wss://i-saw-your-cards.deno.dev');
    ...
    socket.addEventListener('open', (event) => {
        ...
        socket.addEventListener('message', (event) => {
            ...
            document.getElementById('cardapp-log').innerHTML = document.getElementById('cardapp-log').innerHTML + "<li>Server: " + event.data + "</li>";
        });
        ...
        if (!cardappButtonReady) {
            ...
            document.getElementById('cardapp-send').addEventListener('click', async () => {
                ...
                document.getElementById('cardapp-log').innerHTML = document.getElementById('cardapp-log').innerHTML + "<li>Client: " + document.getElementById('carapp-message').value + "</li>";
            });
        }
